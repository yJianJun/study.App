...
import static com.example.agent.autoJS.AutoJsUtil.isAppInstalled;
import static com.example.agent.utils.LogFileUtil.logAndWrite;
...
import com.example.agent.task.AfInfo;
import com.example.agent.task.BigoInfo;
import com.example.agent.task.DeviceInfo;
import com.example.agent.task.TaskUtil;
import com.example.agent.utils.HttpUtil;
